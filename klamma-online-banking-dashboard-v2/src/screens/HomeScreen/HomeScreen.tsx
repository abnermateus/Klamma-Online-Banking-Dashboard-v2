          ...
          <section id="cards">
            <div id="cards-carousel">
              <div className="card">
                ...
                <span className="current-amount">1242.42 <strong>USD</strong></span>
                <span className="card-number">5495 7381 3759 2321</span>
                <span className="card-date">04&nbsp;/&nbsp;24</span>
              </div>
              <div className="card">
                <img src="img/klamma-icon.png" />
                <span className="current-amount">249.00 <strong>EUR</strong></span>
            ...
            <div>
              ...
              <div>
                <div className="activity">
                  ...
                  <p className="activity-value">- 3,004.52 <strong>USD</strong></p>
                </div>
                ...
                <div className="activity">
                  ...
                  <p className="activity-value">- 1,023.19 <strong>USD</strong></p>
                </div>
                ...
                <div className="activity">
                  ...
                  <p className="activity-value">+ 1,456.00 <strong>USD</strong></p>
                </div>
              </div>
            </div>
            <div>
              ...
              <div>
                <div className="activity">
                  ...
                  <p className="activity-value">- 5.99 <strong>USD</strong></p>
                </div>
                ...
                <div className="activity">
                  ...
                  <p className="activity-value">- 4,000.00 <strong>USD</strong></p>
                </div>
              </div>
            </div>
          </section>
